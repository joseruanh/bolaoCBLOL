...
export default function Classificacao(){
    const primeiro = {nome: 'Pickles', pontos: 15, posicao: 1}
    const segundo = {nome: 'Ruanh', pontos: 13, posicao: 2}
    const terceiro = {nome: 'Jean', pontos: 12, posicao: 3}
    const quarto = {nome: 'Relâmpago', pontos: 12, posicao: 3}
    const quinto = {nome: 'Brener', pontos: 11, posicao: 4}
    const sexto = {nome: 'Kennyd', pontos: 9, posicao: 5}
    const setimo = {nome: 'Tony', pontos: 8, posicao: 6}
    const oitavo = {nome: 'Ademiro', pontos: 8, posicao: 6}
