...
export default function Classificacao(){
    const primeiro = {nome: 'Pickles', pontos: 16, posicao: 1}
    const segundo = {nome: 'Ruanh', pontos: 14, posicao: 2}
    const terceiro = {nome: 'Jean', pontos: 13, posicao: 3}
    const quarto = {nome: 'Relâmpago', pontos: 12, posicao: 4}
    const quinto = {nome: 'Brener', pontos: 11, posicao: 5}
    const sexto = {nome: 'Kennyd', pontos: 9, posicao: 6}
    const setimo = {nome: 'Tony', pontos: 9, posicao: 6}
    const oitavo = {nome: 'Ademiro', pontos: 9, posicao: 6}
