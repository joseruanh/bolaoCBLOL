...
export default function Planilha(){
    ...
    pontos11: 5, pontos12: 3, pontos13: 2, pontos14: 2}
    ...
    pontos11: 4, pontos12: 3, pontos13: 2, pontos14: 2}
    ...
    pontos11: 4, pontos12: 3, pontos13: 3, pontos14: 2}
    ...
    pontos11: 3, pontos12: 3, pontos13: 1, pontos14: 2}
    ...
    pontos11: 4, pontos12: 2, pontos13: 2, pontos14: 2}
    ...
    pontos11: 5, pontos12: 3, pontos13: 1, pontos14: 2}
                ...
                <div className="planilha">
                    ...
                    <div className="pRodada">
                        <div>
                            ...
                            <table className="tabelaPLANILHA">
                                <tr>
                                    <td className="destaque">{primeiro.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>KBM</td> <td>RED</td> <td className="destaque">Pontos: {primeiro.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{segundo.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>KBM</td> <td>RED</td> <td className="destaque">Pontos: {segundo.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{terceiro.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>KBM</td> <td>RED</td> <td className="destaque">Pontos: {terceiro.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{quarto.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>KBM</td> <td>RED</td> <td className="destaque">Pontos: {quarto.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{quinto.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>LIB</td> <td>FLA</td> <td className="destaque">Pontos: {quinto.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{sexto.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>KBM</td> <td>RED</td> <td className="destaque">Pontos: {sexto.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{setimo.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>-</td> <td>KBM</td> <td>FLA</td> <td className="destaque">Pontos: {setimo.pontos14}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{oitavo.nome}</td> <td id="win">PNG</td> <td id="win">FUR</td> <td>LLL</td> <td>KBM</td> <td>RED</td> <td className="destaque">Pontos: {oitavo.pontos14}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
