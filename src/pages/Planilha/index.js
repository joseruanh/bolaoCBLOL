...
export default function Planilha(){
    const primeiro = {nome: 'Jean', pontos1: 4, pontos2: 3, pontos3: 3, pontos4: 3, pontos5: 3, pontos6: 4, pontos7: 3, pontos8: 4}
    const segundo = {nome: 'Pickles', pontos1: 4, pontos2: 3, pontos3: 4, pontos4: 5, pontos5: 3, pontos6: 3, pontos7: 3, pontos8: 5}
    const terceiro = {nome: 'Relâmpago', pontos1: 3, pontos2: 3, pontos3: 3, pontos4: 3, pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 5}
    const quarto = {nome: 'Ruanh', pontos1: 3, pontos2: 4, pontos3: 3, pontos4: 4, pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 5}
    const quinto = {nome: 'Brener', pontos1: 4, pontos2: 1, pontos3: 3, pontos4: 3, pontos5: 2, pontos6: 1, pontos7: 3, pontos8: 3}
    const sexto = {nome: 'Kennyd', pontos1: 2, pontos2: 4, pontos3: 3, pontos4: 0, pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 5}
    const setimo = {nome: 'Ademiro', pontos1: 2, pontos2: 5, pontos3: 0, pontos4: 2, pontos5: 2, pontos6: 3, pontos7: 3, pontos8: 3}
    const oitavo = {nome: 'Tony', pontos1: 2, pontos2: 4, pontos3: 0, pontos4: 3, pontos5: 0, pontos6: 3, pontos7: 4, pontos8: 4}
