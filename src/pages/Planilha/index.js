...
export default function Planilha(){
    ...
    pontos5: 3, pontos6: 4, pontos7: 3, pontos8: 4, pontos9: 1, pontos10: 0}
                ...
                <div className="planilha">
                    ...
                    <div className="pRodada">
                        <div>
                            ...
                            <table className="tabelaPLANILHA">
                                <tr>
                                    <td className="destaque">{primeiro.nome}</td> <td id="win">RED</td> <td>FUR</td><td>LIB</td><td>PNG</td><td>KBM</td>    <td className="destaque">Pontos: {primeiro.pontos9}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td className="destaque">{quarto.nome}</td> <td id="win">RED</td> <td>FUR</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {quarto.pontos9}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td className="destaque">{sexto.nome}</td> <td id="win">RED</td> <td>FUR</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {sexto.pontos9}</td>
                                </tr>
                                <tr>
