...
export default function Planilha(){
    const primeiro = {nome: 'Jean', pontos1: 4, pontos2: 3, pontos3: 3, pontos4: 3, pontos5: 3, pontos6: 4, pontos7: 3, pontos8: 1}
    const segundo = {nome: 'Pickles', pontos1: 4, pontos2: 3, pontos3: 4, pontos4: 5, pontos5: 3, pontos6: 3, pontos7: 3, pontos8: 1}
    const terceiro = {nome: 'Relâmpago', pontos1: 3, pontos2: 3, pontos3: 3, pontos4: 3, pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 1}
    const quarto = {nome: 'Ruanh', pontos1: 3, pontos2: 4, pontos3: 3, pontos4: 4, pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 1}
    const quinto = {nome: 'Brener', pontos1: 4, pontos2: 1, pontos3: 3, pontos4: 3, pontos5: 2, pontos6: 1, pontos7: 3, pontos8: 1}
    const sexto = {nome: 'Kennyd', pontos1: 2, pontos2: 4, pontos3: 3, pontos4: 0, pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 1}
    const setimo = {nome: 'Ademiro', pontos1: 2, pontos2: 5, pontos3: 0, pontos4: 2, pontos5: 2, pontos6: 3, pontos7: 3, pontos8: 1}
    const oitavo = {nome: 'Tony', pontos1: 2, pontos2: 4, pontos3: 0, pontos4: 3, pontos5: 0, pontos6: 3, pontos7: 4, pontos8: 1}
                ...
                <div className="planilha">
                    ...
                    <div className="pRodada">
                        <div>
                            ...
                            <table className="tabelaPLANILHA">
                                <tr>
                                    <td className="destaque">{primeiro.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>PNG</td> <td>NET</td> <td>FUR</td> <td className="destaque">Pontos: {primeiro.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{segundo.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>PNG</td> <td>LLL</td> <td>FUR</td> <td className="destaque">Pontos: {segundo.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{terceiro.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>PNG</td> <td>LLL</td> <td>FUR</td> <td className="destaque">Pontos: {terceiro.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{quarto.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>PNG</td> <td>LLL</td> <td>FUR</td> <td className="destaque">Pontos: {quarto.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{quinto.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>ITZ</td> <td>LLL</td> <td>FLA</td> <td className="destaque">Pontos: {quinto.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{sexto.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>PNG</td> <td>LLL</td> <td>FUR</td> <td className="destaque">Pontos: {sexto.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{setimo.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>ITZ</td> <td>LLL</td> <td>FLA</td> <td className="destaque">Pontos: {setimo.pontos8}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{oitavo.nome}</td> <td id="win">KBM</td> <td>RED</td> <td>PNG</td> <td>NET</td> <td>FUR</td> <td className="destaque">Pontos: {oitavo.pontos8}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
