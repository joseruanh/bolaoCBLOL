...
export default function Planilha(){
    ...
    pontos5: 3, pontos6: 4, pontos7: 3, pontos8: 4, pontos9: 2, pontos10: 0}
    const segundo = {nome: 'Pickles', pontos1: 4, pontos2: 3, pontos3: 4, pontos4: 5, 
    pontos5: 3, pontos6: 3, pontos7: 3, pontos8: 5, pontos9: 1, pontos10: 0}
    const terceiro = {nome: 'Relâmpago', pontos1: 3, pontos2: 3, pontos3: 3, pontos4: 3, 
    pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 5, pontos9: 1, pontos10: 0}
    const quarto = {nome: 'Ruanh', pontos1: 3, pontos2: 4, pontos3: 3, pontos4: 4, 
    pontos5: 3, pontos6: 3, pontos7: 4, pontos8: 5, pontos9: 2, pontos10: 0}
    const quinto = {nome: 'Brener', pontos1: 4, pontos2: 1, pontos3: 3, pontos4: 3, 
    pontos5: 2, pontos6: 1, pontos7: 3, pontos8: 3, pontos9: 1, pontos10: 0}
    ...
    pontos5: 0, pontos6: 3, pontos7: 4, pontos8: 4, pontos9: 1, pontos10: 0}
                ...
                <div className="planilha">
                    ...
                    <div className="pRodada">
                        <div>
                            ...
                            <table className="tabelaPLANILHA">
                                <tr>
                                    <td className="destaque">{primeiro.nome}</td> <td id="win">RED</td> <td id="win">FUR</td><td>LIB</td><td>PNG</td><td>KBM</td>    <td className="destaque">Pontos: {primeiro.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{segundo.nome}</td> <td id="win">RED</td> <td>LLL</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {segundo.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{terceiro.nome}</td> <td id="win">RED</td> <td>LLL</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {terceiro.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{quarto.nome}</td> <td id="win">RED</td> <td id="win">FUR</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {quarto.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{quinto.nome}</td> <td id="win">RED</td> <td>LLL</td><td>LIB</td><td>FLA</td><td>KBM</td> <td className="destaque">Pontos: {quinto.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{sexto.nome}</td> <td id="win">RED</td> <td id="win">FUR</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {sexto.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{setimo.nome}</td> <td>-</td> <td>pt2</td><td>pt3</td><td>pt4</td><td>pt5</td> <td className="destaque">Pontos: {setimo.pontos9}</td>
                                </tr>
                                <tr>
                                    <td className="destaque">{oitavo.nome}</td> <td id="win">RED</td> <td>LLL</td><td>LIB</td><td>PNG</td><td>KBM</td> <td className="destaque">Pontos: {oitavo.pontos9}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
